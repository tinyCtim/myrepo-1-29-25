...
# Given physical dimensions: 3 inches (height) x 5 inches (width)
IMAGE_WIDTH_IN = 8.33
IMAGE_HEIGHT_IN = 5.56
...
# --- Execution ---
# NOTE: Replace 'image_66eaba.png' with the actual path to the uploaded image file.
image_file_path = 'continuous_line_drawing.jpg'
